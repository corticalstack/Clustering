"""
=================================================
Example clustering using KDD Cup 1999 IDS dataset
=================================================

The following examples demonstrate clustering in 2D and 3D with and without PCA applied
"""
import pandas as pd
import numpy as np
...
class Clustering:
    ...
    def weight_attack_category(self, weight):
        ...
        for key, value in self.ac_count.items():
            ...
            df_sample = self.dataset[self.dataset.attack_category == key].sample(samples,
